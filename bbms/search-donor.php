...
<div><input type="text" class="form-control" maxlength="6" name="Pincode" name="location" required>
...
$sql = "SELECT * from blooddonors where (status=:status and BloodGroup=:bloodgroup) &&  (Pincode=:location)";
$query = $dbh -> prepare($sql);
